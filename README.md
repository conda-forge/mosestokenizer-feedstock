...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mosestokenizer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6681&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mosestokenizer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mosestokenizer` can be installed with:

```
conda install mosestokenizer
```

It is possible to list all of the versions of `mosestokenizer` available on your platform with:
